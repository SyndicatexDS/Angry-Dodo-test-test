module.exports = {
  OWNER_IDS: [546530387627868171], // Bot owner ID's
  PREFIX: "d!", // Default prefix for the bot
  SUPPORT_SERVER: "998952125285539930", // Your bot support server
  PRESENCE: {
    ENABLED: true, // Whether or not the bot should update its status
    STATUS: "online", // The bot's status [online, idle, dnd, invisible]
    TYPE: "PLAYING", // Status type for the bot [PLAYING | LISTENING | WATCHING | COMPETING]
    MESSAGE: "On The Land of Ark PlayStation Cluster", // Your bot status message
  },
  DASHBOARD: {
  ...
  INTERACTIONS: {
    ...
    TEST_GUILD_ID: "999328490392408215", // Guild ID where the interactions should be registered. [** Test you commands here first **]
  },
  XP_SYSTEM: {
